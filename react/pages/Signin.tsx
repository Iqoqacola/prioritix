...
import Logo from "../../client/src/components/ui/Logoui/Logo";
import { AlertCircle } from "lucide-react";
import { useSignIn } from "../../client/src/hooks/Auth/useSignIneSignIn";
import { useEffect, useState } from "react";
import { useAuthContext } from "../../client/src/hooks/Auth/useAuthContextContext";
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between text-sm">
              <div className="flex items-center">
                ...
                <label
                  htmlFor="remember-me"
                  className="ml-2 block text-text-secondary"
                >
                  Remember me
                </label>
              </div>
